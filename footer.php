					...
					<div class="row pt-5">
							...
							<div class="row">
								...
								<div class="col-12 col-md-4 col-lg-12 appear-animation" data-appear-animation="fadeInLeftShorter" data-appear-animation-delay="400">
									<div class="icon-box icon-box-style-1">
										...
										<div class="icon-box-info mt-1">
											<div class="icon-box-info-title">
												<h3 class="font-weight-bold text-color-dark text-4 mb-0"></h3>
											</div>
											<a href="https://www.facebook.com/gspelectros/" target="_blank"><img src="img/logos/facebook-icon.png" height="40px" width="40px"></a>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="col-lg-8 appear-animation" data-appear-animation="fadeInRightShorter">
							<form class="contact-form" method="POST" id="contact-form">
								<div style="display:none" class="contact-form-success alert alert-success">
									<strong>Success!</strong> Your message has been sent to us.
								</div>
								<div class="contact-form-error alert alert-danger" style="display:none">
									...
									<div class="form-group col">
										...
										<select id="services" name="services" class="form-control">
											<!-- <option value="0">Please select a Service</option> -->
										  	<option value="1">Custom Computer Builds & Repairs</option>
										  	<option value="2">Software Solutions</option>
										  	<option value="3">Network Installations</option>
										  	<option value="4">Hardware Installations</option>
										  	<option value="5">Computer & Hard Drive Backups</option>
								...
								<div class="form-row mt-2">
									<div class="col">
										<input id="send-mail-btn" type="submit" value="SEND MESSAGE" class="btn btn-primary btn-rounded btn-4 font-weight-semibold text-0">
									</div>
								</div>
							</form>
						</div>
					...
					<div class="container">
						<div class="row align-items-center justify-content-md-center">
							...
							<div class="col-12 col-lg-2 text-center order-1 order-lg-2">
								<a href="index.php"><img src="img/logos/gsp-footer-logo.png" width="78" height="70" alt="" class="img-fluid" /></a>
							</div>	
